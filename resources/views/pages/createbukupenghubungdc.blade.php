    ...
    <form method="POST" action="{{ route('dailyBook.add', ['student_id' => $student_id]) }}" enctype="multipart/form-data">
        ...
        <div class="tab">
            <div class="form-group">
                ...
                <input name="pembuat" type="text" class="form-control dcinput" id="pembuatdc" aria-describedby="pembuat" placeholder="Nama Pembuat" autocapitalize="words">
            </div>
            <div class="form-group">
                <label for="tanggaldc" class="dclabel">TANGGAL</label>
                <input name="tanggal" type="date" class="form-control dcinput" id="tanggaldc">
            </div>
            <div class="form-group">
                <label for="temadc" class="dclabel">TEMA</label>
                <input name="tema" type="text" class="form-control dcinput" id="temadc" aria-describedby="tema" placeholder="Tema">
            </div>
            <div class="form-group">
                <label for="subtemadc" class="dclabel">SUBTEMA</label>
                <input name="subtema" type="text" class="form-control dcinput" id="subtemadc" aria-describedby="subtema" placeholder="Sub Tema">
            </div>
        ...
        <div class="tab">
            ...
            <div class="form-group">
                ...
                <textarea name="keteranganFisik" class="form-control dcinput" id="keterangandcfisik" rows="5" placeholder="Keterangan Fisik" maxlength="150"></textarea>
            </div>
            <div class="centerer">
            ...
            <div class="form-group">
                ...
                <textarea name="keteranganKognitif" class="form-control dcinput" id="keterangandckognitif" rows="5" placeholder="Keterangan Kognitif" maxlength="150"></textarea>
            </div>
            <div class="centerer">
            ...
            <div class="form-group">
                ...
                <textarea name="keteranganSosial" class="form-control dcinput" id="keterangandcsosialem" rows="5" placeholder="Keterangan Sosial-emosi" maxlength="150"></textarea>
            </div>
            <button type="button" class="btn btn-primary dcbutton d-flex justify-content-center">
                Next
                <img src="{{asset('svg/nextsign.svg')}}" alt="nextsign">
        ...
        <div class="tab">
            ...
            <div class="form-group">
                ...
                <textarea name="snack" class="form-control dcinput" id="snackdc" rows="5" placeholder="Snack" maxlength="150"></textarea>
            </div>
            <div class="form-group">
                <label for="makansiangdc" class="dclabel ">MAKAN SIANG</label>
                <textarea name="makanSiang" class="form-control dcinput" id="makansiangdc" rows="5" placeholder="Makan Siang" maxlength="150"></textarea>
            </div>
            <div class="form-group">
                <label for="tidursiangdc" class="dclabel ">TIDUR SIANG</label>
                <textarea name="tidurSiang" class="form-control dcinput" id="tidursiangdc" rows="5" placeholder="Tidur Siang" maxlength="150"></textarea>
            </div>
